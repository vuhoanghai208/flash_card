...
// === RELATIONSHIPS (Mối quan hệ) ===
    ...
    greenLife: [
        { en: "inherit (v)", vi: "thừa kế", ipa: "/ɪnˈher.ɪt/" },
        { en: "orchard (n)", vi: "vườn cây ăn quả", ipa: "/ˈɔːtʃəd/" },
        { en: "meadow (n)", vi: "đồng cỏ", ipa: "/ˈmɛdoʊ/" },
        { en: "captivity (n)", vi: "sự giam cầm", ipa: "/kæpˈtɪv.ə.ti/" },
        { en: "biodegradable (adj)", vi: "phân hủy sinh học", ipa: "/ˌbaɪoʊdɪˈɡreɪdəbl/" },
        { en: "contamination (n)", vi: "sự ô nhiễm", ipa: "/kənˌtæmɪˈneɪʃn/" },
        { en: "irreparable (adj)", vi: "không thể sửa chữa/bù đắp", ipa: "/ɪˈrɛpərəbl/" },
        { en: "breeding (n)", vi: "sinh sản", ipa: "/ˈbriːdɪŋ/" },
        { en: "thriving (adj)", vi: "phát triển mạnh", ipa: "/ˈθraɪvɪŋ/" },
        { en: "aggressive (adj)", vi: "hung hăng", ipa: "/əˈɡresɪv/" },
        { en: "blizzard (n)", vi: "bão tuyết", ipa: "/ˈblɪzəd/" },
        { en: "drought (n)", vi: "hạn hán", ipa: "/draʊt/" },
        { en: "hurricane (n)", vi: "bão lớn", ipa: "/ˈhʌrɪkən/" },
        { en: "tsunami (n)", vi: "sóng thần", ipa: "/tsuːˈnɑːmi/" },
        { en: "wildfire (n)", vi: "cháy rừng", ipa: "/ˈwaɪld.faɪər/" },
        { en: "outnumber (v)", vi: "đông hơn", ipa: "/aʊtˈnʌmbər/" },
        { en: "upturn (n)", vi: "sự cải thiện", ipa: "/ˈʌptɜːrn/" },
        { en: "trigger (v)", vi: "kích hoạt", ipa: "/ˈtrɪɡə(r)/" },
        { en: "for one’s sake (n)", vi: "vì lợi ích", ipa: "/seɪk/" },
        { en: "consistent (adj)", vi: "nhất quán", ipa: "/kənˈsɪstənt/" },
        { en: "harness (v)", vi: "khai thác", ipa: "/ˈhɑːnɪs/" },
        { en: "viable (adj)", vi: "khả thi", ipa: "/ˈvaɪəbl/" },
        { en: "disposable (adj)", vi: "sử dụng một lần", ipa: "/dɪˈspəʊzəbl/" },
        { en: "insulation (n)", vi: "vật liệu cách nhiệt", ipa: "/ˌɪnsjʊˈleɪʃən/" },
        { en: "boycott (v)", vi: "tẩy chay", ipa: "/ˈbɔɪ.kɒt/" },
        { en: "conscious (adj)", vi: "có ý thức", ipa: "/ˈkɒnʃəs/" },
        { en: "incentive (n)", vi: "sự khuyến khích", ipa: "/ɪnˈsentɪv/" },
        { en: "decompose (v)", vi: "phân hủy", ipa: "/ˌdiː.kəmˈpəʊz/" },
        { en: "take away (n)", vi: "mua mang về", ipa: "/teɪk əˈweɪ/" },
        { en: "leftover (n)", vi: "thức ăn thừa", ipa: "/ˈleftəʊvə(r)/" },
        { en: "vending (n)", vi: "máy bán hàng tự động", ipa: "/ˈven.dɪŋ/" },
        { en: "in the long run (idiom)", vi: "lâu dài", ipa: "/ɪn ðiː lɒŋ rʌn/" }
    ],
    ai: [
        { en: "proficiency (n)", vi: "sự thành thạo", ipa: "/prə'fi∫nsi/" },
        { en: "effortlessly (adv)", vi: "dễ dàng", ipa: "/ˈef.ət.ləs.li/" },
        { en: "guided (adj)", vi: "có người hướng dẫn", ipa: "/ɡaɪd/" },
        { en: "provoke (v)", vi: "khiêu khích/kích thích", ipa: "/prəˈvəʊk/" },
        { en: "activate (v)", vi: "kích hoạt", ipa: "/ˈæktɪveɪt/" },
        { en: "imitate (v)", vi: "bắt chước", ipa: "/ˈɪmɪteɪt/" },
        { en: "obsolete (adj)", vi: "cổ xưa, lỗi thời", ipa: "/ˌɒb.səlˈiːt/" },
        { en: "tedious (adj)", vi: "chán ngắt, tẻ nhạt", ipa: "/ˈtiːdiəs/" },
        { en: "disinformation (n)", vi: "thông tin sai sự thật", ipa: "/ˌdɪsˌɪnfəˈmeɪʃn/" },
        { en: "humanoid robot (n.phr)", vi: "robot hình người", ipa: "/ˈhjuːmənɔɪd ˈrəʊbɒt/" },
        { en: "domestic household robot (n.phr)", vi: "robot gia đình", ipa: "/dəˈmɛstɪk ˈhaʊshəʊld ˈrəʊbɒt/" },
        { en: "algorithm (n)", vi: "thuật toán", ipa: "/ˈælɡərɪðəm/" },
        { en: "assembly (n)", vi: "việc lắp ráp", ipa: "/əˈsembli/" },
        { en: "diet tracker (n)", vi: "công cụ theo dõi chế độ ăn uống", ipa: "/daɪət ˈtrækə/" },
        { en: "swipe (v)", vi: "vuốt", ipa: "/swaɪp/" },
        { en: "sync (v)", vi: "đồng bộ hóa", ipa: "/sɪŋk/" },
        { en: "accessories (n)", vi: "phụ kiện", ipa: "/əkˈsɛsəriz/" },
        { en: "interface (n)", vi: "giao diện", ipa: "/ˈɪntəfeɪs/" },
        { en: "configure (v)", vi: "cấu hình", ipa: "/kənˈfɪɡjʊə/" },
        { en: "optimize (v)", vi: "tối ưu hóa", ipa: "/ˈɑːptɪmaɪz/" },
        { en: "biased (adj)", vi: "thiên vị", ipa: "/ˈbaɪəst/" },
        { en: "fine-tune (v)", vi: "tinh chỉnh", ipa: "/ˌfaɪnˈtjuːn/" },
        { en: "get around to (phr.v)", vi: "dành thời gian cho", ipa: "/ɡɛt əˈraʊnd tuː/" }
    ],
    urbanisation: [
        { en: "necessity (n)", vi: "nhu cầu thiết yếu", ipa: "/nəˈsesəti/" },
        { en: "relocate (v)", vi: "di chuyển", ipa: "/ˌriːləʊˈkeɪt/" },
        { en: "hub (n)", vi: "trung tâm", ipa: "/hʌb/" },
        { en: "soar (v)", vi: "tăng vọt", ipa: "/ˈsɔːrɪŋ/" },
        { en: "come down with (v)", vi: "bị bệnh", ipa: "/kʌm daʊn wɪð/" },
        { en: "sanitation (n)", vi: "vệ sinh", ipa: "/ˌsænɪˈteɪʃn/" },
        { en: "well-mannered (adj)", vi: "lịch sự", ipa: "/ˌwel ˈmænəd/" },
        { en: "megacity (n)", vi: "siêu đô thị", ipa: "/ˈmeɡəsɪti/" }
    ],
    lifelongLearning: [
        { en: "in-demand (adj)", vi: "có nhu cầu", ipa: "/ɪn dɪˈmɑːnd/" },
        { en: "self-discipline (n)", vi: "tính kỷ luật, tự giác", ipa: "/ˌself ˈdɪsəplɪn/" },
        { en: "aggressive (adj)", vi: "quyết liệt", ipa: "/əˈɡresɪv/" },
        { en: "growth mindset (n.p)", vi: "tư duy phát triển", ipa: "/ˌɡrəʊθ ˈmaɪndset/" },
        { en: "retain (v)", vi: "giữ được, nhớ được", ipa: "/rɪˈteɪn/" },
        { en: "tutorial (n)", vi: "bài hướng dẫn", ipa: "/tjuːˈtɔːriəl/" },
        { en: "track (v)", vi: "theo dõi", ipa: "/træk/" },
        { en: "pace (n)", vi: "tốc độ, nhịp độ", ipa: "/peɪs/" },
        { en: "time-consuming (adj)", vi: "mất nhiều thời gian", ipa: "/ˈtaɪm kənsjuːmɪŋ/" },
        { en: "set aside (phr.v)", vi: "để dành", ipa: "/sɛt əˈsaɪd/" },
        { en: "lucrative (adj)", vi: "sinh lời", ipa: "/ˈluːkrətɪv/" },
        { en: "justification (n)", vi: "sự biện minh, căn cứ", ipa: "/ˌdʒʌstɪfɪˈkeɪʃn/" },
        { en: "glitch (n)", vi: "sự cố", ipa: "/ɡlɪtʃ/" },
        { en: "troubleshooting (n)", vi: "sự cố", ipa: "/ˈtrʌblˌʃuːtɪŋ/" },
        { en: "proactive (adj)", vi: "chủ động", ipa: "/prəʊˈæktɪv/" },
        { en: "insight (n)", vi: "sự sâu sắc", ipa: "/ˈɪnsaɪt/" },
        { en: "internship (n)", vi: "thực tập sinh", ipa: "/ˈɪntɜːnʃɪp/" },
        { en: "on-the-job training (n.phr)", vi: "đào tạo tại chỗ", ipa: "/ɒn ðə dʒɒb ˈtreɪnɪŋ/" },
        { en: "brush up (phr.v)", vi: "ôn lại", ipa: "/brʌʃ ʌp/" },
        { en: "well-rounded (adj)", vi: "toàn diện", ipa: "/ˌwel ˈraʊn.dɪd/" },
        { en: "school -leaver (n)", vi: "ra trường", ipa: "/ˌskuːlˈliː.vər/" },
        { en: "cram for (phr.v)", vi: "nhồi nhét để thi", ipa: "/kræm fɔr/" },
        { en: "commence (v)", vi: "bắt đầu", ipa: "/kəˈmɛns/" },
        { en: "trick (n)", vi: "mẹo/thủ thuật", ipa: "/trɪk/" },
        { en: "tailor (v)", vi: "điều chỉnh theo nhu cầu", ipa: "/ˈteɪ.lɚ/" },
        { en: "extensively (adv)", vi: "rộng rãi", ipa: "/ɪkˈstɛnsɪvli/" },
        { en: "eligible (adj)", vi: "đủ điều kiện", ipa: "/ˈelɪdʒəbl/" }
    ],
    lifeStories: [
        { en: "itinerary (n)", vi: "lịch trình", ipa: "/aɪˈtɪnərəri/" },
        { en: "a blessing in disguise (idiom)", vi: "trong cái rủi có cái may", ipa: "/bi e 'blesɪŋ ın dıs'gaız/" },
        { en: "go round in circles (idiom)", vi: "vòng vo, phí thời gian", ipa: "/ɡoʊ raʊnd ɪn ˈsɜ:rkəlz/" },
        { en: "look/feel like a million bucks (idiom)", vi: "đáng giá nghìn vàng", ipa: "/lʊk/fiːl laɪk ə ˈmɪljən bʌks/" },
        { en: "bent out of shape (idiom)", vi: "giận tím người", ipa: "/bent aʊt ʌv ʃeɪp/" },
        { en: "expose (v)", vi: "phơi ra, bày ra", ipa: "/ɪkˈspəʊz/" },
        { en: "put on an act (phrase)", vi: "giả vờ", ipa: "/pʊt ɒn ən ækt/" },
        { en: "glory (n)", vi: "sự vinh quang, danh tiếng", ipa: "/ˈɡlɔːri/" },
        { en: "furious (adj)", vi: "giận dữ", ipa: "/ˈfjʊə.ri.əs/" },
        { en: "simultaneous (adj)", vi: "đồng thời", ipa: "/ˌsɪm.əlˈteɪ.ni.əs/" },
        { en: "make it on a sports team (phr)", vi: "được chọn vào đội thể thao", ipa: "/meɪk ɪt ɒn ə spɔːrts tiːm/" },
        { en: "tremendous (adj)", vi: "to lớn", ipa: "/trəˈmendəs/" },
        { en: "account (n)", vi: "sự tường thuật", ipa: "/əˈkaʊnt/" },
        { en: "surgeon (n)", vi: "bác sĩ phẫu thuật", ipa: "/ˈsɜːdʒən/" },
        { en: "soldier (n)", vi: "lính, chiến sĩ", ipa: "/ˈsəʊldʒə(r)/" },
        { en: "devote (v)", vi: "cống hiến", ipa: "/dɪˈvəʊt/" },
        { en: "biological (adj)", vi: "thuộc về sinh học", ipa: "/ˌbaɪ.əˈlɒdʒ.ɪ.kəl/" },
        { en: "adoption (n)", vi: "nhận con nuôi", ipa: "/əˈdɒp.ʃən/" },
        { en: "drop out (phr.v)", vi: "bỏ học", ipa: "/drɑːp/" },
        { en: "cutting-edge (adj)", vi: "tiên tiến", ipa: "/ˌkʌt.ɪŋ ˈedʒ/" },
        { en: "genius (n)", vi: "thiên tài", ipa: "/ˈdʒiːniəs/" },
        { en: "dedicated (adj)", vi: "tận tụy", ipa: "/ˈdedɪkeɪtɪd/" },
        { en: "on top of the world (idiom)", vi: "cực hạnh phúc", ipa: "/ɒn tɒp əv ðiː wɜːld/" }
    ],
    career: [
        { en: "live up to (phr.v)", vi: "đáp ứng mong đợi", ipa: "/lɪv ʌp tuː/" },
        { en: "go in for (phr.v)", vi: "tham gia vào", ipa: "/ɡəʊ ɪn fɔːr/" },
        { en: "take into account (idiom)", vi: "quan tâm đến", ipa: "/teɪk/ /ˈɪntuː/ /əˈkaʊnt/" },
        { en: "specialty (n)", vi: "chuyên môn", ipa: "/ˈspeʃ.əl.ti/" },
        { en: "barista (n)", vi: "nhân viên pha chế", ipa: "/bəˈriːstə/" },
        { en: "obsolete (adj)", vi: "lỗi thời", ipa: "/ˌɒb.səlˈiːt/" },
        { en: "self-employed (adj)", vi: "tự kinh doanh", ipa: "/ˌself.ɪmˈplɔɪd/" },
        { en: "recruiter (n)", vi: "nhà tuyển dụng", ipa: "/rɪˈkruː.tər/" },
        { en: "catch up on (phr.v)", vi: "làm bù một việc gì đó", ipa: "/kætʃ ʌp ɒn/" },
        { en: "put on (phr.v)", vi: "tổ chức (sự kiện)", ipa: "/pʊt/" },
        { en: "socialize (v)", vi: "giao lưu kết bạn", ipa: "/ˈsəʊ.ʃəl.aɪz/" },
        { en: "bring up (phr.v)", vi: "bàn bạc, thảo luận", ipa: "/brɪŋ/" },
        { en: "beautician (n)", vi: "chuyên viên làm đẹp", ipa: "/bjuːˈtɪʃn/" },
        { en: "trustworthy (adj)", vi: "đáng tin cậy", ipa: "/ˈtrʌstwɜːði/" },
        { en: "assertive (adj)", vi: "quyết đoán", ipa: "/əˈsɜːrtɪv/" },
        { en: "argumentative (adj)", vi: "thích tranh luận", ipa: "/ɑːrɡjuˈmentətɪv/" },
        { en: "compassionate (adj)", vi: "thương cảm, từ bi", ipa: "/kəmˈpæʃənət/" },
        { en: "conscientious (adj)", vi: "tận tâm", ipa: "/kɑːnʃiˈenʃəs/" },
        { en: "considerate (adj)", vi: "ân cần, chu đáo", ipa: "/kənˈsɪdərət/" },
        { en: "diligent (adj)", vi: "siêng năng", ipa: "/ˈdɪlɪdʒənt/" },
        { en: "gregarious (adj)", vi: "thích giao du", ipa: "/ɡrɪˈɡeriəs/" },
        { en: "intolerant (adj)", vi: "không khoan dung", ipa: "/ɪnˈtɒl.ər.ənt/" },
        { en: "observant (adj)", vi: "tinh mắt, hay quan sát", ipa: "/əbˈzɜːvənt/" },
        { en: "objective (adj)", vi: "khách quan", ipa: "/əbˈdʒektɪv/" },
        { en: "resourceful (adj)", vi: "tháo vát", ipa: "/rɪˈsɔːsfl/" },
        { en: "reserved (adj)", vi: "dè dặt", ipa: "/rɪˈzɜːvd/" },
        { en: "spontaneous (adj)", vi: "tự nhiên, tự phát", ipa: "/spɒnˈteɪ.ni.əs/" },
        { en: "bad-mannered (adj)", vi: "thô lỗ", ipa: "/ˌbædˈmænərd/" },
        { en: "light-hearted (adj)", vi: "vui vẻ, vô tư", ipa: "/ˌlaɪtˈhɑːrtɪd/" },
        { en: "thick-skinned (adj)", vi: "mặt dày, trơ", ipa: "/ˌθɪkˈskɪnd/" },
        { en: "single-minded (adj)", vi: "quyết tâm, chuyên tâm", ipa: "/sɪŋɡl ˈmaɪndɪd/" },
        { en: "persistence (n)", vi: "kiên trì", ipa: "/pəˈsɪs.təns/" },
        { en: "manual (adj)", vi: "bằng tay chân", ipa: "/ˈmænjuəl/" },
        { en: "agility (n)", vi: "sự nhanh nhẹn", ipa: "/əˈdʒɪləti/" },
        { en: "ecstatic (adj)", vi: "vô cùng hạnh phúc", ipa: "/ɪkˈstætɪk/" },
        { en: "competence (n)", vi: "năng lực", ipa: "/ˈkɑːmpɪtəns/" },
        { en: "astonished (adj)", vi: "ngạc nhiên", ipa: "/əˈstɒnɪʃt/" }
    ],
    theWorldOfWork: [
        { en: "put up (phr.v)", vi: "thể hiện", ipa: "/pʊt/ /ʌp/" },
        { en: "follow in someone's footsteps (idiom)", vi: "noi theo/nối nghiệp", ipa: "/ˈfɒl.əʊ ɪn ˈfʊt.step/" },
        { en: "review (n)", vi: "đánh giá/ nhận xét", ipa: "/rɪˈvjuː/" },
        { en: "casual (adj)", vi: "theo thời vụ, tạm thời", ipa: "/ˈkæʒuəl/" },
        { en: "hospitality industry (n.p)", vi: "ngành công nghiệp khách sạn", ipa: "/ˌhɒs.pɪˈtæl.ə.ti ˈɪn.də.stri/" },
        { en: "multitask (v)", vi: "làm nhiều việc cùng lúc", ipa: "/ˌmʌltiˈtɑːsk/" },
        { en: "mentor (n)", vi: "người dẫn dắt", ipa: "/ˈmentɔː(r)/" },
        { en: "nine to five (adj)", vi: "liên quan đến việc văn phòng", ipa: "/naɪn tə faɪv/" },
        { en: "outing (n)", vi: "chuyến đi chơi", ipa: "/ˈaʊtɪŋ/" },
        { en: "perk (n)", vi: "phúc lợi, ưu đãi", ipa: "/pɜːk/" },
        { en: "put someone up to (phr.v)", vi: "xúi giục ai làm gì", ipa: "/pʊt ˈsʌmwʌn ʌp tə/" },
        { en: "put sb off (phr.v)", vi: "làm ai đó mất hứng", ipa: "/pʊt sʌmbədi ɔf/" },
        { en: "adolescence (n)", vi: "tuổi vị thành niên", ipa: "/ˌædəˈlesns/" },
        { en: "visualise (v)", vi: "hình dung", ipa: "/ˈvɪʒuəˌlaɪz/" },
        { en: "output (n)", vi: "sản lượng", ipa: "/ˈaʊtpʊt/" },
        { en: "get down to (phr.v)", vi: "bắt tay vào", ipa: "/ɡɛt daʊn tuː/" },
        { en: "burn out (phr.v)", vi: "kiệt sức", ipa: "/bɜrn aʊt/" }
    ],
    culture: [
        { en: "assimilation (n)", vi: "đồng hóa", ipa: "/əˌsɪməˈleɪʃn/" },
        { en: "stereotype (n)", vi: "khuôn mẫu", ipa: "/ˈsteriətaɪp/" },
        { en: "dominant (adj)", vi: "chiếm ưu thế", ipa: "/ˈdɒmɪnənt/" },
        { en: "indigenous (adj)", vi: "bản địa", ipa: "/ɪnˈdɪdʒənəs/" },
        { en: "embrace (v)", vi: "đón nhận", ipa: "/ɪmˈbreɪs/" },
        { en: "privilege (n)", vi: "đặc quyền", ipa: "/ˈprɪvəlɪdʒ/" },
        { en: "exploitive (adj)", vi: "bóc lột", ipa: "/ɪkˈsplɔɪtɪv/" },
        { en: "obligation (n)", vi: "nghĩa vụ", ipa: "/ˌɒblɪˈɡeɪʃn/" },
        { en: "dynamic (adj)", vi: "năng động", ipa: "/daɪˈnæmɪk/" },
        { en: "booth (n)", vi: "gian hàng", ipa: "/buːð/" },
        { en: "cross-cultural (adj)", vi: "đa văn hóa", ipa: "/ˌkrɒsˈkʌl.tʃər.əl/" },
        { en: "captivate (v)", vi: "thu hút", ipa: "/ˈkæp.tɪ.veɪt/" },
        { en: "stall (n)", vi: "quầy hàng", ipa: "/stɔːl/" },
        { en: "stunning (adj)", vi: "tuyệt đẹp", ipa: "/ˈstʌn.ɪŋ/" },
        { en: "taboo (adj)", vi: "cấm kỵ", ipa: "/təˈbuː/" },
        { en: "disgusting (adj)", vi: "kinh tởm", ipa: "/dɪsˈɡʌstɪŋ/" },
        { en: "bargain (v)", vi: "mặc cả", ipa: "/ˈbɑːɡən/" },
        { en: "baby shower (n.phr)", vi: "buổi tiệc cho bé", ipa: "/ˈbeɪbi ˈʃaʊə/" },
        { en: "coming of age celebration (n.phr)", vi: "lễ kỷ niệm tuổi trưởng thành", ipa: "/ˈkʌmɪŋ əv eɪdʒ ˌsɛlɪˈbreɪʃən/" },
        { en: "feast (n)", vi: "buổi tiệc lớn", ipa: "/fiːst/" },
        { en: "ritual (n)", vi: "nghi thức", ipa: "/ˈrɪtʃuəl/" },
        { en: "adorn (v)", vi: "trang trí", ipa: "/əˈdɔːn/" },
        { en: "partake (v)", vi: "tham gia", ipa: "/pɑːˈteɪk/" },
        { en: "assemble (v)", vi: "tụ tập lại", ipa: "/əˈsembl/" },
        { en: "attire (n)", vi: "trang phục", ipa: "/əˈtaɪə(r)/" }
    ],
    media: [
        { en: "disseminate (v)", vi: "truyền bá", ipa: "/dɪˈsemɪneɪt/" },
        { en: "disguise (v)", vi: "ngụy trang", ipa: "/dɪsˈɡaɪz/" },
        { en: "distort (v)", vi: "bóp méo", ipa: "/dɪˈstɔːrt/" },
        { en: "flatter (v)", vi: "tâng bốc", ipa: "/ˈflætə/" },
        { en: "mislead (v)", vi: "lừa dối", ipa: "/ˌmɪsˈliːd/" },
        { en: "genuine (v)", vi: "chân thật", ipa: "/ˈdʒenjuɪn/" },
        { en: "provocative (adj)", vi: "khiêu khích", ipa: "/prəˈvɑːkətɪv/" },
        { en: "sarcastic (v)", vi: "mỉa mai", ipa: "/sɑːˈkæs.tɪk/" },
        { en: "obsession (n)", vi: "sự ám ảnh", ipa: "/əbˈseʃn/" },
        { en: "facilitate (v)", vi: "tạo điều kiện", ipa: "/fəˈsɪlɪteɪt/" },
        { en: "childish (adj)", vi: "trẻ con, ấu trĩ", ipa: "/ˈtʃaɪl.dɪʃ/" },
        { en: "podcast (n)", vi: "tệp âm thanh", ipa: "/ˈpɒdkɑːst/" },
        { en: "anonymous (adj)", vi: "ẩn danh", ipa: "/əˈnɒnɪməs/" },
        { en: "gossip (n)", vi: "sự tán gẫu, chuyện phiếm", ipa: "/ˈɡɒsɪp/" },
        { en: "self-esteem (n)", vi: "lòng tự tôn", ipa: "/ˌself ɪˈstiːm/" },
        { en: "guilty (adj)", vi: "có tội", ipa: "/ˈɡɪl.ti/" },
        { en: "malware (n)", vi: "phần mềm độc hại", ipa: "/ˈmælweə(r)/" },
        { en: "troll (n)", vi: "người đăng nội dung ác ý, phản cảm lên mạng", ipa: "/trɒl/" },
        { en: "bully (v)", vi: "bắt nạt", ipa: "/ˈbʊli/" },
        { en: "scam (n)", vi: "lừa đảo", ipa: "/skæm/" },
        { en: "billboard (n)", vi: "bảng quảng cáo", ipa: "/ˈbɪlbɔːd/" },
        { en: "flyer (n)", vi: "tờ rơi", ipa: "/ˈflaɪə(r)/" },
        { en: "millennia (n)", vi: "thiên niên kỷ", ipa: "/mɪˈlɛnɪə/" },
        { en: "utilize (v)", vi: "sử dụng", ipa: "/ˈjuːtɪlaɪz/" },
        { en: "news bulletin (n.phr)", vi: "bản tin", ipa: "/njuːz ˈbʊlɪtɪn/" },
        { en: "newsfeed (n)", vi: "bảng tin", ipa: "/ˈnjuːzfiːd/" },
        { en: "profile (n)", vi: "hồ sơ cá nhân", ipa: "/ˈprəʊfaɪl/" },
        { en: "fanbase (n)", vi: "fan hâm mộ", ipa: "/ˈfænbeɪs/" },
        { en: "misleading (adj)", vi: "hiểu lầm", ipa: "/ˌmɪsˈliːdɪŋ/" },
        { en: "outrageous (adj)", vi: "đắt đỏ", ipa: "/aʊtˈreɪdʒəs/" },
        { en: "sloppy (adj)", vi: "thiếu cẩn thận", ipa: "/ˈslɒpi/" },
        { en: "grab (v)", vi: "nắm, bắt lấy", ipa: "/ɡræb/" },
        { en: "catchy (adj)", vi: "bắt tai", ipa: "/ˈkætʃi/" },
        { en: "constitute (v)", vi: "cấu tạo, cấu thành", ipa: "/ˈkɒnstɪtjuːt/" },
        { en: "awash (adj)", vi: "tràn ngập", ipa: "/əˈwɒʃ/" },
        { en: "bombard (v)", vi: "oanh tạc", ipa: "/bɒmˈbɑːrd/" },
        { en: "reputable (adj)", vi: "có uy tín", ipa: "/ˈrɛpjʊtəbl/" },
        { en: "newsworthy (adj)", vi: "đáng đưa tin", ipa: "/ˈnuːzwɜːrði/" },
        { en: "manipulate (v)", vi: "thao túng", ipa: "/məˈnɪp.jə.leɪt/" },
        { en: "tamper (v)", vi: "can thiệp", ipa: "/ˈtæmpər/" },
        { en: "instinct (n)", vi: "bản năng", ipa: "/ˈɪnstɪŋkt/" },
        { en: "ailment (n)", vi: "bệnh tật", ipa: "/ˈeɪlmənt/" },
        { en: "desperate (adj)", vi: "tuyệt vọng", ipa: "/ˈdespərət/" },
        { en: "hospitalize (v)", vi: "nhập viện", ipa: "/ˈhɒspɪtəˌlaɪz/" },
        { en: "deteriorate (v)", vi: "xấu đi", ipa: "/dɪˈtɪriəˌreɪt/" },
        { en: "vandalism (n)", vi: "phá hoại", ipa: "/ˈvæn.dəl.ɪ.zəm/" },
        { en: "underlying (adj)", vi: "cơ bản", ipa: "/ˌʌndərˈlaɪɪŋ/" },
        { en: "mainstream (adj)", vi: "chính thống", ipa: "/ˈmeɪn.striːm/" },
        { en: "shake off (phr.v)", vi: "loại bỏ", ipa: "/ʃeɪk ɒf/" },
        { en: "ill-advised (adj)", vi: "thiếu suy nghĩ", ipa: "/ˌɪl ədˈvaɪzd/" },
        { en: "affair (n)", vi: "vấn đề", ipa: "/əˈfɛr/" },
        { en: "backup (n)", vi: "dự phòng", ipa: "/ˈbækˌʌp/" },
        { en: "tongue-tied (adj)", vi: "líu lưỡi", ipa: "/ˈtʌŋˌtaɪd/" },
        { en: "rehearse (v)", vi: "tập dợt", ipa: "/rɪˈhɜːs/" },
        { en: "nostalgic (adj)", vi: "hoài niệm", ipa: "/nɒsˈtæl.dʒɪk/" },
        { en: "well-reviewed (adj)", vi: "được đánh giá cao", ipa: "/ˈwɛl rɪˌvjuːd/" },
        { en: "gripping (adj)", vi: "hấp dẫn", ipa: "/ˈɡrɪpɪŋ/" }
    ],
    conservation: [
        { en: "enclosure (n)", vi: "nhốt, rào lại", ipa: "/ɪnˈkləʊʒə(r)/" },
        { en: "poacher (n)", vi: "kẻ săn trộm", ipa: "/ˈpəʊ.tʃər/" },
        { en: "veterinarian (n)", vi: "bác sĩ thú y", ipa: "/ˌvet.ər.ɪˈneə.ri.ən/" },
        { en: "spawning ground (n.p)", vi: "nơi sinh sản", ipa: "/ˈspɔː.nɪŋ ˌɡraʊnd/" },
        { en: "occupancy (n)", vi: "sức chứa", ipa: "/ˈɒk.jə.pən.si/" }
    ],
    outIntoTheWorld: [
        { en: "belongings (n)", vi: "đồ dùng cá nhân", ipa: "/bɪˈlɒŋɪŋ/" },
        { en: "discreet (adj)", vi: "thận trọng, kín đáo", ipa: "/dɪˈskriːt/" },
        { en: "pick up (phr v)", vi: "học (ngôn ngữ hoặc kỹ năng)", ipa: "/pɪk ʌp/" },
        { en: "complimentary (adj)", vi: "miễn phí", ipa: "/ˌkɒm.plɪˈmen.tər.i/" },
        { en: "swipe (v)", vi: "quẹt (thẻ)", ipa: "/swaɪp/" },
        { en: "cable car (n.p)", vi: "cáp treo", ipa: "/ˈkeɪ.bəl ˌkɑːr/" }
    ],
    changeTheWorld: [
        { en: "march (v)", vi: "diễu hành", ipa: "/mɑːʧ/" },
        { en: "placard (n)", vi: "biểu ngữ", ipa: "/ˈplækɑːrd/" },
        { en: "viral (adj)", vi: "lan truyền nhanh", ipa: "/ˈvaɪrəl/" },
        { en: "staggering (adj)", vi: "đáng kinh ngạc", ipa: "/ˈstæɡərɪŋ/" },
        { en: "think up (phr.v)", vi: "nghĩ ra", ipa: "/θɪŋk ʌp/" },
        { en: "lifelike (adj)", vi: "giống như thật", ipa: "/ˈlaɪf.laɪk/" },
        { en: "intelligible (adj)", vi: "dễ hiểu", ipa: "" }
    ],
    health: [
        { en: "dairy product (n)", vi: "sản phẩm từ sữa", ipa: "/ˈderi ˈprɑːdəkt/" },
        { en: "fizzy drink (n)", vi: "đồ uống có ga", ipa: "/ˈfɪzi drɪŋk/" },
        { en: "poultry (n)", vi: "gia cầm", ipa: "/ˈpəʊltri/" },
        { en: "processed food (n)", vi: "thực phẩm chế biến sẵn", ipa: "/ˈprɑːsesd fuːd/" },
        { en: "saturated fat (n)", vi: "chất béo bão hòa", ipa: "/ˈsætʃəreɪtɪd fæt/" },
        { en: "fiber (n)", vi: "chất xơ", ipa: "/ˈfaɪ.bər/" },
        { en: "additive (n)", vi: "chất phụ gia", ipa: "/ˈædɪtɪvz/" },
        { en: "mineral (n)", vi: "khoáng chất", ipa: "/ˈmɪnərəl/" },
        { en: "preservative (n)", vi: "chất bảo quản", ipa: "/prɪˈzɜːrvətɪv/" },
        { en: "intensity (n)", vi: "cường độ", ipa: "/ɪnˈtensəti/" },
        { en: "thought-provoking (adj)", vi: "gợi suy nghĩ", ipa: "/ˈθɔːt prəvəʊkɪŋ/" },
        { en: "far-fetched (adj)", vi: "khó tin", ipa: "/ˌfɑːr ˈfetʃt/" },
        { en: "mind-blowing (adj)", vi: "kinh ngạc", ipa: "/ˌmaɪnd ˈbloʊɪŋ/" },
        { en: "half-hearted (adj)", vi: "không nhiệt tình", ipa: "/hæf ˈhɑːrtɪd/" },
        { en: "painkiller (n)", vi: "thuốc giảm đau", ipa: "/ˈpeɪnkɪlə(r)/" }
    ],
    holidaysAndTourism: [
        { en: "cabin (n)", vi: "nhà gỗ nhỏ", ipa: "/ˈkæbɪn/" },
        { en: "caravan (n)", vi: "xe du lịch (nhà di động)", ipa: "/ˈkær.ə.væn/" },
        { en: "soak up (phr.v)", vi: "hấp thụ", ipa: "/səʊk ʌp/" },
        { en: "pamper (v)", vi: "nuông chiều", ipa: "/ˈpæmpər/" },
        { en: "newsletter (n)", vi: "bản tin", ipa: "/ˈnjuːzlɛtər/" },
        { en: "go off (phr.v)", vi: "đi, rời đi", ipa: "/ɡəʊ ɒf/" }
    ],
    relationship: [
        { en: "adore (v)", vi: "yêu thích", ipa: "/əˈdɔː(r)/" },
        { en: "wary (adj)", vi: "cảnh giác", ipa: "/ˈweəri/" },
        { en: "nag (v)", vi: "cằn nhằn", ipa: "/næɡ/" },
        { en: "tease (v)", vi: "trêu chọc", ipa: "/tiz/" },
        { en: "tell sb off (phr.v)", vi: "mắng ai đó", ipa: "/tɛl ˈsʌmbədi ɒf/" },
        { en: "bring up (phr.v)", vi: "đưa ra", ipa: "/brɪŋ/" },
        { en: "like-minded (adj)", vi: "cùng suy nghĩ", ipa: "/laɪk ˈmaɪndɪd/" }
    ],
    problems: [
        { en: "alarmed (adj)", vi: "hoảng sợ", ipa: "/əˈlɑːmd/" },
        { en: "disillusioned (adj)", vi: "vỡ mộng", ipa: "/ˌdɪsɪˈluːʒənd/" },
        { en: "exasperated (adj)", vi: "bực tức", ipa: "/ɪɡˈzæspəreɪtɪd/" },
        { en: "humiliate (v)", vi: "sỉ nhục", ipa: "/hjuːˈmɪlɪeɪ/" },
        { en: "hysterical (adj)", vi: "cuồng loạn", ipa: "/hɪˈstɛrɪkəl/" },
        { en: "irritated (adj)", vi: "bị bực mình", ipa: "/ˈɪrɪteɪtɪd/" },
        { en: "stunned (adj)", vi: "sửng sốt", ipa: "/stʌnd/" },
        { en: "thrilled (adj)", vi: "rất vui mừng", ipa: "/θrɪld/" },
        { en: "upbeat (adj)", vi: "lạc quan", ipa: "/ˈʌpbiːt/" },
        { en: "confrontational (adj)", vi: "đối đầu", ipa: "/kɒnfrʌnˈteɪʃənəl/" },
        { en: "deter (v)", vi: "ngăn chặn", ipa: "/dɪˈtɜːr/" }
    ],
    peopleInHistory: [
        { en: "intellectual (adj)", vi: "trí tuệ", ipa: "/ˌɪntəˈlektʃuəl/" },
        { en: "indolent (adj)", vi: "lười biếng", ipa: "/ˈɪndələnt/" },
        { en: "playwright (n)", vi: "nhà viết kịch", ipa: "/ˈpleɪ.raɪt/" },
        { en: "depict (v)", vi: "miêu tả", ipa: "/dɪˈpɪkt/" },
        { en: "coin (v)", vi: "đặt tên", ipa: "/kɔɪn/" },
        { en: "extract (n)", vi: "đoạn trích", ipa: "/ˈekstrækt/" },
        { en: "showmanship (n)", vi: "kỹ năng trình diễn", ipa: "/ˈʃəʊmənʃɪp/" }
    ],
    liveAndLearn: [
        { en: "dissertation (n)", vi: "luận văn", ipa: "/ˌdɪsəˈteɪʃn/" },
        { en: "major (v)", vi: "học chuyên ngành", ipa: "/ˈmeɪdʒə(r)/" },
        { en: "dyslexia (n)", vi: "chứng khó đọc", ipa: "/dɪsˈleksiə/" },
        { en: "dyscalculia (n)", vi: "chứng khó tính toán", ipa: "/dɪsˈkælkjuːliə/" },
        { en: "autism (n)", vi: "tự kỷ", ipa: "/ˈɔːtɪzəm/" },
        { en: "lenient (adj)", vi: "khoan dung", ipa: "/ˈliːniənt/" },
        { en: "referee (n)", vi: "người giới thiệu", ipa: "/,refə'ri:/" }
    ],
    livingSpace: [
        { en: "estate (n)", vi: "bất động sản", ipa: "/ɪˈsteɪt/" },
        { en: "bustling (adj)", vi: "nhộn nhịp", ipa: "/ˈbʌs.lɪŋ/" },
        { en: "quaint (adj)", vi: "cổ kính", ipa: "/kweɪnt/" },
        { en: "picturesque (adj)", vi: "đẹp như tranh", ipa: "/ˌpɪktʃəˈresk/" },
        { en: "self-contained (adj)", vi: "khép kín", ipa: "/ˌsɛlf kənˈteɪnd/" },
        { en: "cramped (adj)", vi: "chật chội", ipa: "/kræmpt/" },
        { en: "preach (v)", vi: "giảng", ipa: "/priːtʃ/" },
        { en: "dormitory (n)", vi: "kí túc xá", ipa: "/ˈdɔːmətri/" },
        { en: "reassuring (adj)", vi: "đầy trấn an", ipa: "/ˌriːəˈʃʊrɪŋ/" },
        { en: "likewise (adv)", vi: "tương tự", ipa: "/ˈlaɪkwaɪz/" },
        { en: "mitigate (v)", vi: "giảm nhẹ", ipa: "/ˈmɪtɪɡeɪt/" }
    ],
    generationGap: [
        { en: "go out of (adj)", vi: "lỗi mốt", ipa: "" },
        { en: "restate (v)", vi: "nhắc lại", ipa: "/ˌriːˈsteɪt/" },
        { en: "follow one’s dream (idiom)", vi: "theo đuổi ước mơ", ipa: "" },
        { en: "digital native (n)", vi: "người được sinh ra ở thời đại công nghệ và Internet", ipa: "/ˌdɪdʒ.ɪ.təl ˈneɪ.tɪv/" },
        { en: "take away (v.phr)", vi: "cất đi", ipa: "/teɪk əˈweɪ/" },
        { en: "centenarian (n)", vi: "người sống trên 100 tuổi", ipa: "/,senti'neəriən/" },
        { en: "toddler (n)", vi: "trẻ mới biết đi", ipa: "/ˈtɒd.lər/" },
        { en: "naughty (adj)", vi: "nghịch ngợm", ipa: "/ˈnɔːti/" },
        { en: "grow out of (phr v)", vi: "ngừng làm việc gì khi lớn lên", ipa: "/ɡrəʊ aʊt əv/" },
        { en: "live up to (phr v)", vi: "đúng", ipa: "/lɪv ʌp tuː/" },
        { en: "social strata (n)", vi: "các tầng lớp xã hội", ipa: "/ˈsəʊ.ʃəl ˈstrɑː.tə/" },
        { en: "powerless (adj)", vi: "bất lực", ipa: "/ˈpaʊə.ləs/" }
    ],
    ecologicalSystems: [
        { en: "glacier (n)", vi: "sông băng", ipa: "/ˈɡlæs.i.ər/" },
        { en: "hot spring (n)", vi: "suối nước nóng", ipa: "/hɒt sprɪŋ/" },
        { en: "bear (v)", vi: "chịu đựng", ipa: "/beə(r)/" },
        { en: "invasive (adj)", vi: "các loài xâm lấn", ipa: "/ɪnˈveɪ.sɪv/" },
        { en: "mangrove (n)", vi: "rừng ngập mặn", ipa: "/ˈmæŋ.ɡrəʊv/" }
    ],
    independentLife: [
        { en: "oversleep (v)", vi: "ngủ quên", ipa: "/ˌəʊvəˈsliːp/" },
        { en: "self-motivated (adj)", vi: "năng động", ipa: "/ˌself ˈməʊtɪveɪtɪd/" },
        { en: "get into the habit of (vp)", vi: "tạo thói quen", ipa: "/ɡet ˈɪn.tuː ðiː ˈhæb.ɪt əv/" },
        { en: "to-do-list (n)", vi: "danh sách việc cần làm", ipa: "/təˈduː ˌlɪst/" },
        { en: "the odd one out (idiom)", vi: "kẻ/ người khác biệt", ipa: "/ðiː ɒd wʌn aʊt/" },
        { en: "stand up to (phrasal verb)", vi: "đứng lên chống lại", ipa: "/stænd ʌp tu:/" },
        { en: "self-reliant (adj)", vi: "tự chủ", ipa: "/ˌself rɪˈlaɪənt/" },
        { en: "self-esteem (adj)", vi: "lòng tự trọng", ipa: "/ˌself ɪˈstiːm/" },
        { en: "deodorant (n)", vi: "chất khử mùi", ipa: "/diˈəʊ.dər.ənt/" },
        { en: "odor (n)", vi: "mùi", ipa: "/ˈəʊ.dər/" },
        { en: "odor (n)", vi: "mùi", ipa: "/ˈəʊ.dər/" },
        { en: "impulsive (adj)", vi: "bốc đồng", ipa: "/ɪmˈpʌl.sɪv/" },
        { en: "tricky (adj)", vi: "khó khăn", ipa: "/ˈtrɪk.i/" },
        { en: "apply pressure (vp)", vi: "sơ cứu ép tim", ipa: "/əˈplaɪ ˈpreʃ.ər/" }
    ],
    citiesOfTheFuture: [
        { en: "commuter (n)", vi: "người đi lại", ipa: "/kəˈmjuː.tər/" },
        { en: "wordy (adj)", vi: "dài dòng", ipa: "/ˈwɜː.di/" },
        { en: "hustle (v)", vi: "hối hả", ipa: "/ˈhʌs.əl/" },
        { en: "pedicab (n)", vi: "xích lô", ipa: "/ˈped.ɪ.kæb/" },
        { en: "fountain (n)", vi: "đài phun nước", ipa: "/ˈfaʊntən/" },
        { en: "refreshment (n)", vi: "giải khát", ipa: "/ri'fre∫mənt/" },
        { en: "beverage (n)", vi: "đồ uống", ipa: "/ˈbev.ər.ɪdʒ/" },
        { en: "yacht (n)", vi: "du thuyền", ipa: "/jɒt/" },
        { en: "cargo (n)", vi: "hàng hóa", ipa: "/ˈkɑː.ɡəʊ/" },
        { en: "self-catering (adj)", vi: "tự túc ăn uống", ipa: "/ˌselfˈkeɪ.tər.ɪŋ/" },
        { en: "transboundary (adj)", vi: "xuyên biên giới", ipa: "/trænzˈbaʊn.dər.i/" },
        { en: "cyborg (n)", vi: "người máy", ipa: "/ˈsaɪ.bɔːɡ/" },
        { en: "amenity (n)", vi: "tiện nghi", ipa: "/əˈmiː.nə.ti/" },
        { en: "metropolis (n)", vi: "đô thị", ipa: "/məˈtrɒp.əl.ɪs/" },
        { en: "evade (v)", vi: "trốn tránh", ipa: "/ɪˈveɪd/" },
        { en: "drone (n)", vi: "không người lái", ipa: "/drəʊn/" },
        { en: "hyperloop (n)", vi: "tàu siêu tốc chạy bằng cảm ứng điện từ", ipa: "/ˈhaɪpə(r) luːp/" },
        { en: "maglev train (n)", vi: "tàu đệm từ", ipa: "/ˈmæɡ.lev ˌtreɪn/" },
        { en: "desirable (adj)", vi: "đáng mơ ước", ipa: "/dɪˈzaɪə.rə.bəl/" },
        { en: "condo (n)", vi: "chung cư", ipa: "/ˈkɒn.dəʊ/" },
        { en: "tropical cyclone (np)", vi: "lốc xoáy nhiệt đới", ipa: "/ˈtrɒp.ɪ.kəl ˈsaɪ.kləʊn/" },
        { en: "catastrophe (n)", vi: "thảm họa", ipa: "/kəˈtæs.trə.fi/" },
        { en: "underprivileged (adj)", vi: "kém may mắn", ipa: "/ˌʌn.dəˈprɪv.əl.ɪdʒd/" },
        { en: "cynical (adj)", vi: "hoài nghi", ipa: "/ˈsɪn.ɪ.kəl/" },
        { en: "semi-detached (adj)", vi: "nhà liền kề", ipa: "/ˌsem.i.dɪˈtætʃt/" },
        { en: "terraced (adj)", vi: "nhà có bậc thang", ipa: "/ˈterəst/" },
        { en: "sedentary (adj)", vi: "ủy mị", ipa: "/ˈsed.ən.tər.i/" },
        { en: "vintage (adj)", vi: "cổ điển", ipa: "/ˈvɪn.tɪdʒ/" },
        { en: "suspension bridge (np)", vi: "cầu treo", ipa: "/səˈspen.ʃən ˌbrɪdʒ/" },
        { en: "reclaim (v)", vi: "đòi lại", ipa: "/rɪˈkleɪm/" },
        { en: "solitary (adj)", vi: "đơn độc", ipa: "/ˈsɒl.ɪ.tər.i/" },
        { en: "aspiration (n)", vi: "khát vọng", ipa: "/ˌæs.pɪˈreɪ.ʃən/" },
        { en: "unthinkable (adj)", vi: "không tưởng", ipa: "/ʌnˈθɪŋ.kə.bəl/" },
        { en: "cut off (vp)", vi: "xa nhà", ipa: "/ˈkʌt.ɒf/" },
        { en: "aristocracy (adj)", vi: "quý tộc", ipa: "/ˌær.ɪˈstɒk.rə.si/" },
        { en: "soak up (vp)", vi: "hòa mình", ipa: "/səʊk ʌp/" },
        { en: "gadget (n)", vi: "tiện ích", ipa: "/ˈɡædʒɪt/" },
        { en: "goat (adj)", vi: "tuyệt vời nhất mọi thời đại", ipa: "/ɡəʊt/" },
        { en: "stunt (n)", vi: "nguy hiểm", ipa: "/stʌnt/" },
        { en: "contagious (adj)", vi: "bệnh truyền nhiễm", ipa: "/kənˈteɪ.dʒəs/" },
        { en: "body clock (n)", vi: "đồng hồ sinh học", ipa: "/ˈbɒd.i ˌklɒk/" },
        { en: "insomnia (n)", vi: "bệnh mất ngủ", ipa: "/ɪnˈsɒm.ni.ə/" },
        { en: "treadmill (n)", vi: "máy chạy bộ", ipa: "/ˈtred.mɪl/" },
        { en: "lactose (n)", vi: "đường sữa", ipa: "/ˈlæk.təʊs/" },
        { en: "out of this word (idiom)", vi: "tuyệt vời, không còn lời để diễn tả", ipa: "" },
        { en: "pitch (n)", vi: "sân bóng đá", ipa: "/pɪtʃ/" },
        { en: "rink (n)", vi: "sân trượt", ipa: "/rɪŋk/" },
        { en: "soundproof (n)", vi: "cách âm", ipa: "/ˈsaʊnd.pruːf/" },
        { en: "state-of-the-art (adj)", vi: "tiên tiến, hiện đại", ipa: "/ˌsteɪt.əv.ðiːˈɑːt/" },
        { en: "proceed (n)", vi: "doanh thu", ipa: "/ˈprəʊ.siːdz/" },
        { en: "bungalow (n)", vi: "nhà một tầng, biệt lập", ipa: "/ˈbʌŋɡələʊ/" },
        { en: "detached (adj)", vi: "biệt lập", ipa: "/dɪˈtætʃt/" },
        { en: "conservatory (n)", vi: "nhà kính", ipa: "/kənˈsɜː.və.tər.i/" },
        { en: "dilapidated (adj)", vi: "xuống cấp", ipa: "/dɪˈlæp.ɪ.deɪ.tɪd/" },
        { en: "contemporary (adj)", vi: "hiện đại", ipa: "/kənˈtemprəri/" },
        { en: "estate (n)", vi: "tương tự", ipa: "/ɪˈsteɪt/" },
        { en: "stackable (adj)", vi: "xếp chồng lên nhau", ipa: "/ˈstæk.ə.bəl/" },
        { en: "bunk (n)", vi: "giường tầng", ipa: "/bʌŋk/" },
        { en: "dump (v)", vi: "đặt", ipa: "/dʌmp/" },
        { en: "splendor (n)", vi: "vẻ huy hoàng", ipa: "/ˈsplen.dər/" },
        { en: "thoughtfulness (n)", vi: "sự chu đáo", ipa: "/ˈθɔːt.fəl.nəs/" },
        { en: "psychiatric (adj)", vi: "tâm thần", ipa: "/ˌsaɪ.kiˈæt.rɪk/" },
        { en: "ask out (phr v)", vi: "rủ đi chơi", ipa: "/ɑːsk aʊt/" },
        { en: "avid (adj)", vi: "khao khát", ipa: "/ˈævɪd/" },
        { en: "odd (adj)", vi: "kỳ quặc", ipa: "/ɒd/" },
        { en: "evident (adj)", vi: "rõ ràng", ipa: "/ˈevɪdənt/" },
        { en: "apathetic (adj)", vi: "thờ ơ", ipa: "/ˌæp.əˈθet.ɪk/" },
        { en: "lethargic (adj)", vi: "lười biếng", ipa: "/ləˈθɑː.dʒɪk/" },
        { en: "deliberately (adv)", vi: "cố tình", ipa: "/dɪˈlɪb.ər.ət.li/" },
        { en: "originality (n)", vi: "sự độc đáo", ipa: "/əˌrɪdʒ.ənˈæl.ə.ti/" },
        { en: "masculine (n)", vi: "nam tính", ipa: "/ˈmæs.kjə.lɪn/" },
        { en: "feminine (adj)", vi: "nữ tính", ipa: "/ˈfemənɪn/" },
        { en: "vandalism (n)", vi: "phá hoại", ipa: "/ˈvæn.dəl.ɪ.zəm/" },
        { en: "drab (adj)", vi: "buồn tẻ", ipa: "/dræb/" },
        { en: "blunt (adj)", vi: "nói thẳng", ipa: "/blʌnt/" },
        { en: "grip (v)", vi: "hấp dẫn", ipa: "/ɡrɪp/" },
        { en: "lifelike (adj)", vi: "sống động", ipa: "/ˈlaɪf.laɪk/" },
        { en: "alley (n)", vi: "sân chơi", ipa: "/ˈæl.i/" },
        { en: "license plate (n)", vi: "biển số xe", ipa: "/ˈlaɪ.səns ˌpleɪt/" },
        { en: "hybrid (n)", vi: "kết hợp", ipa: "/ˈhaɪ.brɪd/" },
        { en: "notepad (n)", vi: "sổ ghi chú", ipa: "/ˈnəʊt.pæd/" }
    ],
    healthGrade11: [
        { en: "germ (n)", vi: "vi trùng", ipa: "/dʒɜːm/" },
        { en: "herb (n)", vi: "thảo mộc", ipa: "/hɜːb/" },
        { en: "detox (n)", vi: "giải độc", ipa: "/ˈdiː.tɒks/" },
        { en: "stale (adj)", vi: "không còn tươi", ipa: "/steɪl/" },
        { en: "rotten (adj)", vi: "bị hỏng", ipa: "/ˈrɒt.ən/" },
        { en: "appetite (n)", vi: "thèm ăn", ipa: "/ˈæpɪtaɪt/" },
        { en: "vegan (n)", vi: "người ăn chay", ipa: "/ˈviː.ɡən/" },
        { en: "fussy (adj)", vi: "kén ăn", ipa: "/ˈfʌs.i/" },
        { en: "catering industry (np)", vi: "ngành công nghệ thực phẩm", ipa: "/ˈkeɪ.tər.ɪŋ ˈɪn.də.stri/" },
        { en: "weird (adj)", vi: "kì dị", ipa: "/wɪəd/" },
        { en: "prescription (n)", vi: "đơn thuốc", ipa: "/prɪˈskrɪp.ʃən/" },
        { en: "speculate (v)", vi: "suy đoán", ipa: "/ˈspekjuleɪt/" },
        { en: "dehydrated (adj)", vi: "mất nước", ipa: "/ˌdiː.haɪˈdreɪ.tɪd/" },
        { en: "mascot (n)", vi: "linh vật", ipa: "/ˈmæs.kɒt/" }
    ],
    globalWarming: [
        { en: "protest (n,v)", vi: "cuộc biểu tình", ipa: "/ˈprəʊtest/" },
        { en: "heatwave (n)", vi: "nắng nóng", ipa: "/ˈhiːtweɪv/" },
        { en: "carpool (n)", vi: "đi chung xe", ipa: "/ˈkɑːˌpuːl/" }
    ],
    heritage: [
        { en: "give voice to sth (idiom)", vi: "đưa ra tiếng nói", ipa: "" },
        { en: "crowdfunding (n)", vi: "huy động vốn từ cộng đồng", ipa: "/ˈkraʊd.fʌn.dɪŋ/" },
        { en: "terrace (n)", vi: "dãy nhà", ipa: "/ˈter.əs/" },
        { en: "acropolis (n)", vi: "đô thị", ipa: "/əˈkrɒp.ə.lɪs/" },
        { en: "authentic (adj)", vi: "đích thực", ipa: "/ɔːˈθentɪk/" },
        { en: "descend (v)", vi: "hậu duệ", ipa: "/dɪˈsend/" },
        { en: "go about (vp)", vi: "to begin to do something or deal with something", ipa: "/ɡəʊ əˈbaʊt/" }
    ],
    technology: [
        { en: "tech-savvy (adj)", vi: "có hiểu biết nhiều về công nghệ, nhất là máy tính", ipa: "/tek ˈsæv.i/" },
        { en: "geek (n)", vi: "người rất am hiểu về một lĩnh vực nào đó, đặc biệt là về công nghệ, máy tính", ipa: "/ɡiːk/" },
        { en: "hotspot (n)", vi: "điểm có thể kết nối mạng, điểm nóng (nơi có tình hình chiến sự bất ổn)", ipa: "/ˈhɒt.spɒt/" },
        { en: "console (v)", vi: "an ủi", ipa: "/kənˈsəʊl/" },
        { en: "obsessed (adj)", vi: "ám ảnh", ipa: "/əbˈsest/" },
        { en: "grasp (n)", vi: "sự nắm vững, hiểu biết về một chủ đề hay sự kiện khó", ipa: "/ɡrɑːsp/" },
        { en: "brainchild (n)", vi: "ý tưởng phát minh thuộc về trí tuệ, ý tưởng gốc", ipa: "/ˈbreɪn.tʃaɪld/" }
    ]
    ,
    // ===========================================
